...
class AdMobAuthentication:
    ...
    TOKEN_FILE = 'app_statistics/token.pickle'
    ...
    def authenticate(self, client_secrets_path: str) -> Resource:
        ...
        # client_secrets file.
            ...
            flow = Flow.from_client_secrets_file(
                client_secrets_path, scopes=[self.API_SCOPE])
            ...
            print(
                f"\nWaiting for authorization and callback to: {self.REDIRECT_URI}...")
            ...
            code = self._get_authorization_code(passthrough_val)
        ...
        admob = build(self.API_NAME, self.API_VERSION, credentials=credentials)
        return admob

    def _get_authorization_code(self, passthrough_val):
